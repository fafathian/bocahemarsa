            ...
            <div class="kumpulan-rambu">
                ...
                <table class="table table-responsive table-striped">
                    ...
                    <tbody style="  display:block;
                        ...
                        $sql = "select * from RambuBiru order by id_RB desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="edit.php?Id_gambar=<?= $data["id_RB"]; ?>" class='btn btn-warning'>Edit</a>
                                    <a href="../deletebiru.php?Id_gambar=<?= $data["id_RB"]; ?>" class="btn btn-danger" onclick="return alert('Are you sure you want to delete?')">Delete</a>
                            </tr>
