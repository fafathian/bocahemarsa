...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO RambuHijau (name, nama_gambar, Deskripsi) VALUES ('$image', '" . $_POST['Nama'] . "','" . $_POST['Deskripsi'] . "')";
...
$result = mysqli_query($connect, "SELECT * FROM RambuHijau");
    ...
    <section class="side">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show">
                                <div class="card-body">
                                    <a href="tambah_rambu.php">Rambu A</a>
                                </div>
                                <div class="card-body">
                                    <a href="rambukuning.php">Rambu Kuning</a>
                                </div>
                                <div class="card-body">
                                    <a href="rambuhijau.php">Rambu Hijau</a>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse show">
                                <div class="card-body">
                                    <a href="../Data/data_rambu.php">Data Rambu</a>
                                </div>
                                <div class="card-body">
                                    <a href="../Data/datakuning.php">Data Rambu Kuning</a>
                                </div>
                                <div class="card-body">
                                    <a href="../Data/datahijau.php">Data Rambu Hijau</a>
                                </div>
                                <div class="card-body">
        ...
        <section class="content">
            <div class="kumpulan-rambu">
                <h2 class="mb-4 mt-4">TAMBAH GAMBAR RAMBU BERWARNA HIJAU</h2>
